    ...
    for (var point of points) {
        ...
        if (sceneReady) {
            if (intersects.length === 0) {
                ...
                const intersectionDist = intersects[0].distance;
                const pointDist = point.position.distanceTo(camera.position);
        ...
        const translateX = Math.round(screenPosition.x * sizes.width * 0.5);
        const translateY = Math.round(screenPosition.y * sizes.height * 0.5);
